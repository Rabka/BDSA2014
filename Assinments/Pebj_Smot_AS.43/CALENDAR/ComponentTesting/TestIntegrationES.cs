...
namespace ComponentTesting
{
    ...
    public class TestIntegrationES
    {
        ...
        public void PathTest_JoinComponentsToNewComposite()
        {
            ...
            Assert.AreEqual(true, season.OnlineContext.GetEventComponent(ec2.TableID).GetLeafs()[0].TableID == e1.TableID ||
        ...
        public void EquivalenceTest_AddComponentsToComposite()
        {
            ...
            Assert.AreEqual(true, season.OnlineContext.GetEventComponent(ec1.TableID).GetLeafs()[0].TableID == e3.TableID ||
        ...
        public void BoundaryTest_AddComponentsToComposite()
        {
            ...
            Assert.AreEqual(true, season.OnlineContext.GetEventComponent(ec1.TableID).GetLeafs()[0].TableID == e2.TableID ||
        ...
        public void PathTest_AddComponentsToComposite()
        {
            ...
            Assert.AreEqual(true, season.OnlineContext.GetEventComponent(ec2.TableID).GetLeafs()[0].TableID == e6.TableID ||
